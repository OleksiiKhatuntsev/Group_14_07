...
class Analysis():
  def __init__(self, team_membership_lookup, teams):
    for student in team_membership_lookup.find_all_students_of_team(teams):
      print(f'{student} is in {teams} team.')
...
Analysis(team_memberships, Teams.BLUE_TEAM)